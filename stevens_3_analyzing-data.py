...
#Import libraries
import sqlite3 as s3, pandas as pd, numpy as np
...
htmlFile = open('stevens_3_1_data-analysis.html', 'w') #open HTML file for output and write header and start of table
...
\n</style>
\n<body>
\n<h1>CMC Quotient Data for Extent Magic the Gathering Cards by Set</h1>
\n<h3>Analysis by Ray Stevens</h3>
...
#start the new table
htmlFile.write('''\n<h1>Keyword Usage in the Innistrad Sets</h1>
\n<h3>Analysis by Ray Stevens</h3>
